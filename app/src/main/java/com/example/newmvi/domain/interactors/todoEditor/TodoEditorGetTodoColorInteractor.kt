...
class TodoEditorGetTodoColorInteractor @Inject constructor(
    ...
    override fun invoke(
        ...
        return event.filterIsInstance<TodoEditorEvent.GetColor>()
            .map {
                delay(randomTime())
                TodoEditorEvent.GotColor(repo.getTodoColor(it.color))
